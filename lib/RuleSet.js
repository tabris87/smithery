            ...
            if (Object.keys(oChecks.propertyChecks).length > 0) {
                ...
                for (var iIndex of aChecks) {
                    ...
                    for (var oAttributeCheck of oCheck.attributes) {
                        ...
                        if (oAttributeCheck.action === "equals" && !(typeof oLatestNode[oAttributeCheck.name] !== "undefined" && this._attributeFits(oLatestNode[oAttributeCheck.name], oAttributeCheck.value)/* oLatestNode[oAttributeCheck.name] === oAttributeCheck.value */)) {
                            return false;
                        }
                    }
                }
