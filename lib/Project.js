...
class Project {
    constructor() {
        ...
        this._parser.addParser(DirParser.parse, 'DIR');
        this._parser.addParser(DirParser.parse, 'FILE');
        ...
        this._projectAST = this._parser.parse({
            lang: 'DIR',
    ...
    build(sConfigName) {
        ...
        while (aFeatures.length > 0) {
            ...
            resultFST = this._imposer.impose(resultFST, featureFST);
        }
